...
export const createTemplateDocument = (templateId: string) =>
  Endpoint.post(`/templates/${templateId}/documents/`).then((r) => r.data);

export const getTemplateDocument = (templateId: string, documentId: string) =>
  Endpoint.get(`/templates/${templateId}/documents/${documentId}`).then((r) => r.data);
