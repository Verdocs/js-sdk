...
export const createTemplateTag = (templateId: string) =>
  Endpoint.post(`/templates/${templateId}/tags/`).then((r) => r.data);

export const getTemplateTags = (templateId: string) =>
  Endpoint.get(`/templates/${templateId}/tags/`).then((r) => r.data);
